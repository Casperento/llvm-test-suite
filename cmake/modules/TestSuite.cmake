...
function(llvm_test_executable_no_test target)
  ...
  if(TEST_SUITE_COLLECT_INSTCOUNT)
    string(SUBSTRING ${CMAKE_CXX_FLAGS_RELEASE} 1 -1 CMAKE_CXX_FLAGS_RELEASE)
    add_custom_command(TARGET ${target} POST_BUILD
      ...
      COMMAND ${CMAKE_CXX_COMPILER} -fembed-bitcode ${CFLAGS} ${CPPFLAGS} ${CXXFLAGS} ${CMAKE_CXX_FLAGS_RELEASE} -o $<TARGET_FILE:${target}> $<TARGET_FILE:${target}>.bc
      COMMAND objcopy $<TARGET_FILE:${target}> --dump-section .llvmbc=$<TARGET_FILE:${target}>.bc
